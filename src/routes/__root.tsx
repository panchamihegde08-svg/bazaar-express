...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Fresh groceries, snacks, drinks and daily essentials from G.K Bazaar delivered to your door in minutes. Cash on delivery." },
      { property: "og:title", content: "G.K Bazaar — Groceries delivered in 15 minutes" },
      { property: "og:description", content: "Fresh groceries and daily essentials from G.K Bazaar. Cash on delivery." },
